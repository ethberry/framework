...
export default {
  ...
  networks: {
    ...
    besu: {
      url: `https://besu.gemunion.io`, // http://127.0.0.1:8545
      timeout: 142000,
      accounts: [
        "0x3551a60e21c15bd7cf36eb98cadba972e44aed3e7405f3bcee3c8d8fcb03c95", // 0x61284003E50b2D7cA2B95F93857abB78a1b0F3Ca
