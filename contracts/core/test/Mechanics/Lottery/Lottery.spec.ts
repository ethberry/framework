...
describe("Lottery", function () {
  ...
  describe("finalizeRound", function () {
    it("should finalize round with 1 ticket and get commission", async function () {
      ...
      await expect(tx0)
        .to.emit(lotteryInstance, "PurchaseLottery")
        .withArgs(1, receiver.address, amount, 1, defaultNumbers);
  ...
  describe("PurchaseLottery", function () {
    ...
    it("should fail: no more tickets available", async function () {
      ...
      await expect(tx2)
        .to.emit(lotteryInstance, "PurchaseLottery")
        .withArgs(2, stranger.address, amount, 1, defaultNumbers);
