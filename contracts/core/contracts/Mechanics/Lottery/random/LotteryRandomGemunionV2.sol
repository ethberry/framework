...
contract LotteryRandomGemunionV2 is LotteryRandomV2, ChainLinkGemunionV2 {
  constructor(
    string memory name,
  ...
  function fulfillRandomWords(uint256 requestId, uint256[] memory randomWords) internal override(LotteryRandomV2, VRFConsumerBaseV2) {
