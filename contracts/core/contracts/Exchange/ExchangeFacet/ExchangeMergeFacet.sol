...
contract ExchangeMergeFacet is SignatureValidator, DiamondOverride {
  ...
  function merge(
    ...
    ExchangeUtils.burnFrom(price, _msgSender(), params.receiver, DisabledTokenTypes(true, true, false, false, true));
    ExchangeUtils.acquireFrom(items, params.receiver, _msgSender(), DisabledTokenTypes(true, true, false, false, true));
