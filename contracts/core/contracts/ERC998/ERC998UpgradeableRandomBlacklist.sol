...
contract ERC998UpgradeableRandomBlacklist is ERC998UpgradeableRandom, BlackList {
  constructor(
    string memory name,
  ...
  function supportsInterface(
    bytes4 interfaceId
  ) public view virtual override(AccessControl, ERC998UpgradeableRandom) returns (bool) {
