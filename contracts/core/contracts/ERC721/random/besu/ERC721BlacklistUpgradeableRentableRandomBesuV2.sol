...
abstract contract ERC721BlacklistUpgradeableRentableRandomBesuV2 is
  ERC721BlacklistUpgradeableRentableRandomV2,
  ChainLinkBesuV2
{
  constructor(
    string memory name,
  ...
  override(ERC721BlacklistUpgradeableRentableRandomV2, VRFConsumerBaseV2) {
