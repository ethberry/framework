...
contract ERC721RandomGoerliV2 is ERC721RandomV2, ChainLinkGoerliV2 {
  constructor(
    string memory name,
    string memory symbol,
    uint96 royalty,
    string memory baseTokenURI
  ) ERC721RandomV2(name, symbol, royalty, baseTokenURI) ChainLinkGoerliV2(uint64(1), uint16(6),uint32(600000),uint32(1)){}
