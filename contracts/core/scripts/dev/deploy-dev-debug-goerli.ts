...
*/
  ...
  contracts.erc998Simple = erc998SimpleFactory.attach("0xb83ad33c4d04a830667eb915a56ae7f9b07e1698");
  /*
  // await debug(contracts);
  ...
  // // await debug(contracts);
*/
  const erc998RandomFactory = await ethers.getContractFactory("ERC998RandomGoerli");
  ...
  const erc998RandomInstance = erc998RandomFactory.attach("0xe935223d7dc50878b5a664bce05c2ce63f281a7f");
  ...
  */
  ...
  contracts.erc1155Simple = erc1155SimpleFactory.attach("0x8cfae8e9968222d2dc75813cdd576b346e503330");
  // // await debug(contracts);
  /*
  ...
  */
  ...
  contracts.erc721MysteryboxSimple = mysteryboxSimpleFactory.attach("0xeacb993d611a9831fb3a4ba1399166067e95f95e");
  /*
  // await debug(contracts);
...
*/
  ...
  /*
    ...
    await debug(
      await stakingInstance.setRules([
        {
          externalId: 45, // ERC998 > MYSTERIOUS BOX
          deposit: {
            tokenType: 3,
  ...
  contracts.erc721Lottery = erc721LotteryFactory.attach("0x6b7586baef5dcd834e5e60f81f5211637d50fd6b");
  ...
  const lotteryFactory = await ethers.getContractFactory("LotteryRandomGoerli");
  ...
  // contracts.lottery = await lotteryFactory.deploy(
  //   "Lottery",
  //   "0x6b7586baef5dcd834e5e60f81f5211637d50fd6b",
  //   "0xe85c9cdd5ba93b0b3893e38a8b71c868a63f31c3",
  // );

  contracts.lottery = lotteryFactory.attach("0xb0b3ceac1ca8860ab5015802a741747816235838");
  // // await debug(contracts);
  //
  ...
  contracts.waitlist = waitlistFactory.attach("0x2e7e44ac067a1705bf2b8615661099ca722b735a");
  // // await debug(contracts);

  // TODO change proof get from @openzeppelin/merkel-tree
  ...
  contracts.erc721Wrapper = erc721WrapFactory.attach("0x94b070ed9382eb1e568e888eebaa2823cbb34687");
  // await debug(contracts);
  ...
  await grantRoles(
    [
      ...
      contracts.erc721Lottery.address,
      contracts.erc721MysteryboxSimple.address,
