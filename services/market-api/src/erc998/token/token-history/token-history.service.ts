...
import { Erc998TokenEventType, ITokenApprovedForAll, ITokenHistorySearchDto } from "@framework/types";
...
export class Erc998TokenHistoryService {
  ...
  public async search(dto: ITokenHistorySearchDto): Promise<[Array<Erc998TokenHistoryEntity>, number]> {
  ...
  public async getApprove(userEntity: UserEntity, contract: string): Promise<boolean> {
    ...
    return (historyEntity.eventData as ITokenApprovedForAll).approved;
  }
}
