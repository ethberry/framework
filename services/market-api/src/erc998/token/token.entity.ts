...
import { Erc998TokenHistoryEntity } from "./token-history/token-history.entity";
...
export class Erc998TokenEntity extends IdDateBaseEntity implements IErc998Token {
  ...
  @OneToMany(_type => Erc998TokenHistoryEntity, history => history.erc998Token)
  public history: Array<Erc998TokenHistoryEntity>;
}
