...
import { UniTemplateStatus, IErc1155Token, IErc1155TemplateSearchDto } from "@framework/types";
...
export const Erc1155Token: FC = () => {
  const {
    ...
    handleChangePage,
    handleDeleteConfirm,
  } = useCollection<IErc1155Token, IErc1155TemplateSearchDto>({
          ...
          {rows.map((token, i) => (
            <ListItem key={i}>
              ...
              <ListItemSecondaryAction>
                ...
                <IconButton onClick={handleDelete(token)} disabled={token.tokenStatus === UniTemplateStatus.INACTIVE}>
                  <Delete />
                </IconButton>
              </ListItemSecondaryAction>
            </ListItem>
