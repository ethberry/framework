...
export const Dropbox: FC = () => {
  const {
    ...
    filter: ({ id, title, description, imageUrl, item, price, dropboxStatus, templateId, contractId }) =>
      id
        ? { title, description, imageUrl, item, price, dropboxStatus, templateId, contractId }
