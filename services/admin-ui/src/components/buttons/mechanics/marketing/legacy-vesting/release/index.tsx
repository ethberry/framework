...
import VestingReleaseABI from "@framework/abis/json/LegacyVesting/release.json";

export interface ILegacyVestingReleaseButtonProps {
  balance: IBalance;
  className?: string;
  disabled?: boolean;
...
export const LegacyVestingReleaseButton: FC<ILegacyVestingReleaseButtonProps> = props => {
