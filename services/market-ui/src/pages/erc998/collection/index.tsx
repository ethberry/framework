...
import { IErc998Collection, IErc998CollectionSearchDto } from "@framework/types";
...
export const Erc998Collection: FC = () => {
  const { selected, isLoading } = useCollection<IErc998Collection, IErc998CollectionSearchDto>({
  ...
  return (
    <Fragment>
      <Breadcrumbs path={["dashboard", "erc998-collections", "erc998-collection"]} data={[{}, {}, selected]} />
