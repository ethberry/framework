...
import { ParticleFacebookLoginButton, ParticleGoogleLoginButton } from "@gemunion/login-button-particle";
...
const router = createBrowserRouter([
  {
    ...
    children: [
      ...
      },
      {
        path: "/login",
        element: (
          <FirebaseLogin wallets={[MetamaskLoginButton, ParticleGoogleLoginButton, ParticleFacebookLoginButton]} />
        ),
      },
