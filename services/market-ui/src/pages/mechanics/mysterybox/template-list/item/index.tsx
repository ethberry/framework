...
interface IMysteryboxTemplateItemProps {
  template: ITemplate;
}

export const MysteryboxTemplateItem: FC<IMysteryboxTemplateItemProps> = props => {
  ...
  return (
    <Card>
      <CardActionArea component={RouterLink} to={`/mysterybox-templates/${template.id}`}>
