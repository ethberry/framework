...
import { LegacyVestingReleasableButton, LegacyVestingReleaseButton } from "../../../../../../components/buttons";
        ...
        <StyledListWrapper count={rows.length} isLoading={isLoading}>
          {rows.map(row => (
            <StyledListItem key={row.id}>
              ...
              <ListActions>
                <LegacyVestingReleasableButton balance={row} />
                <LegacyVestingReleaseButton balance={row} />
              </ListActions>
            </StyledListItem>
          ))}
        </StyledListWrapper>
