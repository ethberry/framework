...
import VestingReleasableABI from "@framework/abis/json/LegacyVesting/releasable.json";

export interface ILegacyVestingReleasableButtonProps {
  balance: IBalance;
  className?: string;
  disabled?: boolean;
...
export const LegacyVestingReleasableButton: FC<ILegacyVestingReleasableButtonProps> = props => {
