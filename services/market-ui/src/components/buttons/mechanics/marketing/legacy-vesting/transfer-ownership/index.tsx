...
import VestingTransferOwnershipABI from "@framework/abis/json/Ownable/transferOwnership.json";

import { AccountDialog, IAccountDto } from "../../../../../dialogs/account";

interface ILegacyVestingTransferOwnershipButtonProps {
  className?: string;
  disabled?: boolean;
...
export const LegacyVestingTransferOwnershipButton: FC<ILegacyVestingTransferOwnershipButtonProps> = props => {
