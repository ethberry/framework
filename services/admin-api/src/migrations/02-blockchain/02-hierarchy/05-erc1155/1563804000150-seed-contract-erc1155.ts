  ...
  public async up(queryRunner: QueryRunner): Promise<any> {
    ...
    await queryRunner.query(`
      INSERT INTO ${ns}.contract (
        ...
        'Resources (simple)',
        '${simpleFormatting}',
        'https://firebasestorage.googleapis.com/v0/b/gemunion-firebase.appspot.com/o/DO_NOT_REMOVE%2Fresources.png?alt=media&token=abe28478-b19a-47a2-979f-62950aae2927',
        '',
        '',
        100,
        '${baseTokenURI}',
        ...
        'Potions (blacklist)',
        '${simpleFormatting}',
        'https://firebasestorage.googleapis.com/v0/b/gemunion-firebase.appspot.com/o/DO_NOT_REMOVE%2Fpotions.png?alt=media&token=db790592-76fe-4cba-a79a-eb140ca63efd',
        '',
        '',
        100,
        '${baseTokenURI}',
