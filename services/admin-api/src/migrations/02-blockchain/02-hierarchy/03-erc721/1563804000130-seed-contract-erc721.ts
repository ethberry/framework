  ...
  public async up(queryRunner: QueryRunner): Promise<any> {
    ...
    await queryRunner.query(`
      INSERT INTO ${ns}.contract (
        ...
        'Gems (simple)',
        '${simpleFormatting}',
        'https://firebasestorage.googleapis.com/v0/b/gemunion-firebase.appspot.com/o/DO_NOT_REMOVE%2Fgems.png?alt=media&token=ce8c4ae7-c3df-407d-976b-805a3bb4e819',
        'GEMS',
        'GEMS721',
        100,
        '${baseTokenURI}',
        ...
        'Jewelry (blacklist)',
        '${simpleFormatting}',
        'https://firebasestorage.googleapis.com/v0/b/gemunion-firebase.appspot.com/o/DO_NOT_REMOVE%2Fjewelry.png?alt=media&token=1b64ed02-de2b-4474-b7fc-e1d9e0352dd8',
        'ERC721 BLACKLIST',
        'BL721',
        100,
        '${baseTokenURI}',
        ...
        'Armour (lvl)',
        '${simpleFormatting}',
        'https://firebasestorage.googleapis.com/v0/b/gemunion-firebase.appspot.com/o/DO_NOT_REMOVE%2Farmour.png?alt=media&token=cd830dc3-8e98-4315-8b93-7f13e8f9dcf3',
        'ARMOUR',
        'LVL721',
        100,
        '${baseTokenURI}',
        ...
        'Weapon (random)',
        '${simpleFormatting}',
        'https://firebasestorage.googleapis.com/v0/b/gemunion-firebase.appspot.com/o/DO_NOT_REMOVE%2Fweapon.png?alt=media&token=42d72749-ba72-4d0d-b412-df3d08ee7783',
        'WEAPON',
        'RNG721',
        100,
        '${baseTokenURI}',
        ...
        'Awards (soulbound)',
        '${simpleFormatting}',
        'https://firebasestorage.googleapis.com/v0/b/gemunion-firebase.appspot.com/o/DO_NOT_REMOVE%2Fawards.png?alt=media&token=5e913abf-f903-4d7e-ad13-5a2a27356de0',
        'SOULBOUND',
        'SB721',
        100,
        '${baseTokenURI}',
        ...
        'Transport (rentable)',
        '${simpleFormatting}',
        'https://firebasestorage.googleapis.com/v0/b/gemunion-firebase.appspot.com/o/DO_NOT_REMOVE%2Ftransport.png?alt=media&token=2270c175-37d9-40dc-a14d-bfa57c402b1e',
        'RENTABLE',
        'REN721',
        100,
        '${baseTokenURI}',
