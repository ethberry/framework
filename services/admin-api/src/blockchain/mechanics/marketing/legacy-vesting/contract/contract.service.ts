...
import { AchievementLevelEntity } from "../../../meta/achievements/level/level.entity";
import { BalanceEntity } from "../../../../hierarchy/balance/balance.entity";

@Injectable()
export class LegacyVestingService {
  constructor(
    @InjectRepository(ContractEntity)
    private readonly contractEntityRepository: Repository<ContractEntity>,
  ) {}

  public async search(dto: Partial<ILegacyVestingContractSearchDto>): Promise<[Array<ContractEntity>, number]> {
