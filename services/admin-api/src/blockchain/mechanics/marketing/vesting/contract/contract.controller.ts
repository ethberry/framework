...
export class VestingContractController {
  constructor(private readonly vestingContractService: VestingContractService) {}
  ...
  public search(
    ...
    return this.vestingContractService.search(dto, userEntity);
  }
  ...
  public update(
    ...
    return this.vestingContractService.update({ id }, dto, userEntity);
  }

  @Get("/:id")
  @UseInterceptors(NotFoundInterceptor)
  public findOne(@Param("id", ParseIntPipe) id: number): Promise<ContractEntity | null> {
    return this.vestingContractService.findOne({ id });
  }

  @Delete("/:id")
  @HttpCode(HttpStatus.NO_CONTENT)
  public async delete(@Param("id", ParseIntPipe) id: number, @User() userEntity: UserEntity): Promise<void> {
    await this.vestingContractService.delete({ id }, userEntity);
  }
}
