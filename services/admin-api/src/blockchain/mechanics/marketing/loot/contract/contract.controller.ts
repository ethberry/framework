...
export class LootContractController {
  ...
  public search(
    ...
    return this.lootContractService.search(dto, userEntity);
  }
  ...
  public update(
    ...
    return this.lootContractService.update({ id }, dto, userEntity);
  }
  ...
  public async delete(@Param("id", ParseIntPipe) id: number, @User() userEntity: UserEntity): Promise<void> {
    await this.lootContractService.delete({ id }, userEntity);
  }
}
