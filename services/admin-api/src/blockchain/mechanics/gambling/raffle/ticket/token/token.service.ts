...
@Injectable()
export class RaffleTicketTokentService extends TokenService {
  constructor(
  ...
  public async search(dto: Partial<IRaffleTicketTokenSearchDto>): Promise<[Array<TokenEntity>, number]> {
