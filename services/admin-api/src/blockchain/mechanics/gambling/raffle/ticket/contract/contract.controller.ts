...
export class RaffleTicketContractController {
  ...
  public search(
    ...
    return this.raffleTicketContractService.search(dto, userEntity);
  }
  ...
  public update(
    ...
    return this.raffleTicketContractService.update({ id }, dto, userEntity);
  }
  ...
  public async delete(@Param("id", ParseIntPipe) id: number, @User() userEntity: UserEntity): Promise<void> {
    await this.raffleTicketContractService.delete({ id }, userEntity);
  }
}
