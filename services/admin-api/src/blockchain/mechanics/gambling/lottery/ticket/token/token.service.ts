...
@Injectable()
export class LotteryTicketTokenService extends TokenService {
  constructor(
  ...
  public async search(dto: Partial<ILotteryTicketTokenSearchDto>): Promise<[Array<TokenEntity>, number]> {
