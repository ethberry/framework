...
export class PredictionContractController {
  ...
  public search(
    ...
    return this.predictionContractService.search(dto, userEntity);
  }
  ...
  public update(
    ...
    return this.predictionContractService.update({ id }, dto, userEntity);
  }
  ...
  public async delete(@Param("id", ParseIntPipe) id: number, @User() userEntity: UserEntity): Promise<void> {
    await this.predictionContractService.delete({ id }, userEntity);
  }
}
