...
import { ContractManagerErc998Controller } from "./erc998.controller";
...
@Module({
  ...
  providers: [ethersRpcProvider, ethersSignerProvider, ContractManagerErc998SignService],
  controllers: [ContractManagerErc998Controller],
  exports: [ContractManagerErc998SignService],
})
export class ContractManagerErc998Module {}
