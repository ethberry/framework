...
import { ContractManagerLootController } from "./loot.controller";
...
@Module({
  ...
  providers: [ethersRpcProvider, ethersSignerProvider, ContractManagerLootSignService],
  controllers: [ContractManagerLootController],
  exports: [ContractManagerLootSignService],
})
export class ContractManagerLootModule {}
