...
import { ContractManagerRaffleController } from "./raffle.controller";
...
@Module({
  ...
  providers: [ethersRpcProvider, ethersSignerProvider, ContractManagerRaffleSignService],
  controllers: [ContractManagerRaffleController],
  exports: [ContractManagerRaffleSignService],
})
export class ContractManagerRaffleModule {}
