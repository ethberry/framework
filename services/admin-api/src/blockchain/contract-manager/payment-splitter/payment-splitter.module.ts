...
import { ContractManagerPaymentSplitterController } from "./payment-splitter.controller";
...
@Module({
  ...
  providers: [ethersRpcProvider, ethersSignerProvider, ContractManagerPaymentSplitterSignService],
  controllers: [ContractManagerPaymentSplitterController],
  exports: [ContractManagerPaymentSplitterSignService],
})
export class ContractManagerPaymentSplitterModule {}
