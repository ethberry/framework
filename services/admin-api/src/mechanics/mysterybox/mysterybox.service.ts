...
export class MysteryboxService {
  ...
  public async update(
    ...
    if (price) {
      await this.assetService.update(mysteryboxEntity.price, price);
    }
  ...
  public async create(dto: IMysteryboxCreateDto): Promise<MysteryboxEntity> {
    ...
    const contractEntity = await this.contractService.findOne({ address: process.env.MYSTERYBOX_ADDR });
