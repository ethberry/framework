...
export class MysteryContractController {
  ...
  public search(
    ...
    return this.mysteryContractService.search(dto, userEntity);
  }
  ...
  public update(
    ...
    return this.mysteryContractService.update({ id }, dto, userEntity);
  }
  ...
  public async delete(@Param("id", ParseIntPipe) id: number, @User() userEntity: UserEntity): Promise<void> {
    await this.mysteryContractService.delete({ id }, userEntity);
  }
}
