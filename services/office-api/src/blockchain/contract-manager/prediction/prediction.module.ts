...
import { ContractManagerPredictionController } from "./prediction.controller";
...
@Module({
  ...
  providers: [ethersRpcProvider, ethersSignerProvider, ContractManagerPredictionSignService],
  controllers: [ContractManagerPredictionController],
  exports: [ContractManagerPredictionSignService],
})
export class ContractManagerPredictionModule {}
