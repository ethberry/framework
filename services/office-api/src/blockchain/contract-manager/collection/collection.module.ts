...
import { ContractManagerCollectionController } from "./collection.controller";
...
@Module({
  ...
  providers: [ethersRpcProvider, ethersSignerProvider, ContractManagerCollectionSignService],
  controllers: [ContractManagerCollectionController],
  exports: [ContractManagerCollectionSignService],
})
export class ContractManagerCollectionModule {}
