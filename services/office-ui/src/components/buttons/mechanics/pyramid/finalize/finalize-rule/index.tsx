...
import PyramidFinalizeByRuleIdABI from "../../../../../../abis/components/buttons/mechanics/pyramid/finalize/finalize-rule/finalizeByRuleId.abi.json";
...
export const PyramidFinalizeRuleButton: FC<IPyramidFinalizeRuleButtonProps> = props => {
  ...
  const metaFinalizeRule = useMetamask(async (rule: IPyramidRule, web3Context: Web3ContextType) => {
    ...
    const contract = new Contract(rule.contract.address, PyramidFinalizeByRuleIdABI, web3Context.provider?.getSigner());
