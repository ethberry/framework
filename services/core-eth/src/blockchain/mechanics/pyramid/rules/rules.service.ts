...
export class PyramidRulesService {
  ...
  // public findOneWithStake(stakingId: string, contract: string): Promise<PyramidStakesEntity | null> {
  //   const queryBuilder = this.stakesEntityRepository.createQueryBuilder("rule");
  //   queryBuilder.leftJoinAndSelect("stake.deposit", "deposit");
  //
