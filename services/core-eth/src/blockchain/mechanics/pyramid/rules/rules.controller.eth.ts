...
export class PyramidRulesControllerEth {
  ...
  public create(@Payload() event: ILogEvent<IPyramidCreate>, @Ctx() context: Log): Promise<void> {
  ...
  public update(@Payload() event: ILogEvent<IPyramidUpdate>, @Ctx() context: Log): Promise<void> {
