...
@Injectable()
export class ContractManagerLootServiceEth extends ContractManagerServiceEth {
  constructor(
    @Inject(Logger)
  ...
  public async deploy(event: ILogEvent<IContractManagerLootTokenDeployedEvent>, context: Log): Promise<void> {
    const {
