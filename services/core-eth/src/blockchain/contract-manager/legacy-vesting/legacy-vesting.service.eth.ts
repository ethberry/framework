...
@Injectable()
export class ContractManagerLegacyVestingServiceEth extends ContractManagerServiceEth {
  constructor(
    @Inject(Logger)
  ...
  public async deploy(event: ILogEvent<IContractManagerLegacyVestingDeployedEvent>, context: Log): Promise<void> {
    const {
      name,
