...
export class ContractManagerVestingServiceEth extends ContractManagerServiceEth {
  ...
  public async deploy(event: ILogEvent<IContractManagerVestingTokenDeployedEvent>, context: Log): Promise<void> {
    const {
    ...
    await this.contractService.create({
      ...
      contractFeatures:
        contractTemplate === "0"
          ? []
          : (Object.values(VestingContractTemplates)[Number(contractTemplate)].split("_") as Array<ContractFeatures>),
