...
sudo -H -u app docker run --rm \
    ...
    -v "/home/app:/home/app" \
    -w="/home/app" \
    docker/compose:1.24.0 -f docker-compose-cloudbuild.yml up -d nginx
...
sudo -H -u app docker run --rm \
    ...
    -v "/home/app:/home/app" \
    -w="/home/app" \
    docker/compose:1.24.0 -f docker-compose-cloudbuild.yml up -d core-eth core-eth-binance core-eth-binance-test core-eth-polygon core-eth-mumbai
